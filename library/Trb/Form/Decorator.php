...
class Trb_Form_Decorator
{
    ...
    protected static function setFormDefaults( Zend_Form $form, $format )
    {
        ...
        if ( self::BOOTSTRAP == $format || self::BOOTSTRAP_MINIMAL == $format || self::BOOTSTRAP_GROUP == $format ) {
    ...
    )
    {
        ...
        if ( $form->getElement( $submit_str ) ) {
            ...
            if ( self::BOOTSTRAP == $format || self::BOOTSTRAP_MINIMAL == $format || self::BOOTSTRAP_GROUP == $format ) {
                ...
                if ( $form->getElement( $cancel_str ) && ( self::BOOTSTRAP == $format || self::BOOTSTRAP_GROUP == $format ) ) {
        ...
        if ( $form->getElement( $cancel_str ) ) {
            ...
            if ( self::BOOTSTRAP == $format || self::BOOTSTRAP_MINIMAL == $format || self::BOOTSTRAP_GROUP == $format ) {
                ...
                if ( $form->getElement( $submit_str ) && ( self::BOOTSTRAP == $format || self::BOOTSTRAP_GROUP == $format ) ) {
