 ...
 * @copyright Urbs@2015
 */
class Trb_Application_Resource_Log extends Zend_Application_Resource_ResourceAbstract
{
    ...
    public function init()
    {
        ...
        if ( !isset( $_SESSION['limpa_log'] ) )
        {
            ...
            if ( Trb_Controller_Action_Helper_FileHelper::deleteFilesOlderThen( $options['life_time'], $options['directory'] ) )
            {
