 ...
 * @package     Trb_Db
 * @subpackage  Table
 * @name        Trb_Db_Table_Abstract
 * @copyright   Copyright (c) 2014 - TRB
 * @author      TRB
 * @version     1.0
 */
abstract class Trb_Db_Table_Abstract extends Zend_Db_Table_Abstract
{
    /**
    ...
    /**
     * Retorna uma instancia da classe filha de Trb_Db_Table_Abstract
     *
     * @return Trb_Db_Table_Abstract
     */
    ...
    public function setTotal( $sub_select = null )
    {
        ...
        try {
            ...
            Trb_Action_Helper::logger( $e->getMessage(), Zend_Log::ERR );
        }
    }
     ...
     *
     * @param   array|Trb_Model_Abstract $data Dados a serem inseridos
     * @param   boolean $transaction Se é para utilizar transação ou não (default: TRUE)
    ...
    {
        //se o objeto é filho da classe Trb_Model_Abstract, converte para um array
        if ( get_parent_class( $data ) == 'Trb_Model_Abstract' ) {
            $data = $data->toArray();
        }
        ...
        try {
            ...
            Trb_Action_Helper::logger( $e->getMessage() . $params, Zend_Log::ERR );
